...
public:
	...
	inline void Normalize() {
		float oneOverLength = Length();
		oneOverLength = 1.0 / oneOverLength; x *= oneOverLength; y *= oneOverLength; z *= oneOverLength;
	}
...
public:
    ...
    RayDifferential() { hasDifferentials = false; ID = rand(); }
