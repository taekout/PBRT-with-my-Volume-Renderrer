...
class BlackbodyLight;

// Scene Declarations
class Scene {
public:
    // Scene Public Methods
    Scene(Primitive *accel, const vector<Light *> &lts, const vector<bool> &_IsLightFireKind, VolumeRegion *vr);
    ~Scene();
    ...
    Primitive *aggregate;
    vector<Light *> lights;
	vector<bool >	IsLightFireKind;
	int				nNormalLightIndex;
