...
public:
	...
	virtual inline Point GetPoint(void) { return Point(-1.f, -1.f, -1.f); }
	virtual inline Spectrum GetIntensity(void) { printf("Wrong!! Light Function called."); exit(-1); return Spectrum(-1.f, -1.f, -1.f); }
