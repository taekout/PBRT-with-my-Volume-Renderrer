...
public:
	...
	Spectrum sigma_a(int _x, int _y, int _z, const Vector & vec) const {
		printf("Deprecated sigma_a in HomogeneousVolumeDensity.\n");
		exit(-14);
		return 0.f;
	}
	...
	Spectrum sigma_s(int _x, int _y, int _z, const Vector & vec) const {
		printf("Deprecated sigma_s in HomogeneousVolumeDensity.\n");
		exit(-14);
		return 0.f;
	}
